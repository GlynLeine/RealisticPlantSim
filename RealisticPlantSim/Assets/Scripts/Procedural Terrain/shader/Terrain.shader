Shader "HDRP/Custom/Terrain"
{
    ...
    // Constants
        // Pin the shader to be hardcoded opaque, transparency is not supported!
        const float _SurfaceType = 0.0;
        const float _SrcBlend = 1.0;
        const float _DstBlend = 0.0;
        const float _AlphaSrcBlend = 1.0;
        const float _AlphaDstBlend = 0.0;
    //
